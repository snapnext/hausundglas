      ...
      <div className="container area-grid">
        <div>
          ...
          <h2 className="h1" style={{ marginTop: 12 }}>
            Wir kommen zu Ihnen — im Rhein-Erft-Kreis und Köln.
          </h2>
          <p className="body-lg" style={{ marginTop: 20, color: 'var(--fg-2)', maxWidth: 520 }}>
            Pulheim ist unser Standort, Köln und die umliegenden Gemeinden sind unser Zuhause.
            Andere Adressen auf Anfrage.
          </p>
        ...
        <div className="area-map" aria-hidden="true">
          <svg viewBox="0 0 500 400" preserveAspectRatio="xMidYMid meet">
            ...
            <g>
              ...
              <text x="334" y="245" fontSize="13" fill="#0F172A" fontFamily="Barlow" fontWeight="600">
                Köln
              </text>
            </g>
            <g>
              <circle cx="240" cy="280" r="5" fill="#0284C7" />
              <text x="252" y="284" fontSize="12" fill="#334155" fontFamily="Barlow" fontWeight="500">
                Frechen
              </text>
            </g>
            <g>
              <circle cx="135" cy="225" r="5" fill="#0284C7" />
              <text x="60" y="229" fontSize="12" fill="#334155" fontFamily="Barlow" fontWeight="500">
                Brauweiler
              </text>
            </g>
            <g>
              <circle cx="100" cy="135" r="5" fill="#0284C7" />
              <text x="40" y="139" fontSize="12" fill="#334155" fontFamily="Barlow" fontWeight="500">
                Bergheim
              </text>
            </g>
            <g>
              <circle cx="140" cy="320" r="5" fill="#0284C7" />
              <text x="80" y="324" fontSize="12" fill="#334155" fontFamily="Barlow" fontWeight="500">
                Kerpen
              </text>
            </g>
            <circle
